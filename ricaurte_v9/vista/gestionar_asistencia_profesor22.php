<?php
    ...
    $consulta="SELECT nombre_curso from asignacion_curso WHERE id_documento = '$documento'";
...
<body>
    <div class="container">
        ...
        <tr align="center" bgcolor="#FFFF99">
            <td width="50%">No. Curso</td>
            <td width="50%">Consultar</td>
        </tr>
        ...
        while ($cursos = $resultado->fetch_object()) {
            ...
            <tr bgcolor="#CCCCFF">
                ...
                <td align="center"><a href="asistencia23.php?Cursos=<?php echo $cursos->nombre_curso?>"><img src="../Imagenes/editar.jpg"  width="29" height="24" /></a></td>
            </tr>
        <?php
        }
        ?>
