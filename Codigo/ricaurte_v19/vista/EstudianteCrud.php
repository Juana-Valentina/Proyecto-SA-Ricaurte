<?php 
    ...
    $sql = "SELECT * FROM registropersona where id_documento in(select id_documento from asignacion_materia_curso where nombre_rol = 'Estudiante' and nombre_curso= '$Curso' and id_materia = '$Materias')";
...
<td><a class="btn btn-danger" href="../controlador/eliminarEstudiante.php?Persona=<?php echo $persona->id_documento ?>&Curso=<?php echo $Curso ?>&Materia=<?php echo $Materias ?>&Documentos=<?php echo $documento ?>">Eliminar</a></td>
</tr>
<?php
}
?>
        ...
        <a href="../vista/ConsultarCursosMateriasE.php?Documentos= <?php echo $documento ?>" class="btn btn-danger" id="cancelarBtn">Regresar</a>
