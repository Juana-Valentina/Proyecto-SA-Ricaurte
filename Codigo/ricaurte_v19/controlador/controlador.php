...
$documentos = $_REQUEST['DocumentoPerfil'];
        ...
        if(isset($_GET['accion'])){
            ...
            while($accion !== ""){
                ...
                switch ($accion) {
                    ...
                    //estudiante
                    // case 'perfil':
                    //     header("location: ../vista/perfil.php?Documentacion=$documentos");
                    //     break;
                    case 'iniciar_sesion':
                    ...
                    case 'anadir_curso':
                        header("location: ../vista/curso.php?Documentos= $documento"); 
                        break;
                    ...
                    case 'horario_p':
                        header("location: ../vista/asignacion_materia_curso.php?"); 
                        break;

                    case 'horario_e':
                        header("location: ../vista/HorarioP.php?Documentos= $documento");  
                        break;
                    case 'horario_Estudiantes':
                        header("location: ../vista/ConsultarCursosMateriasE.php?Documentos= $documento");  
                        break;
