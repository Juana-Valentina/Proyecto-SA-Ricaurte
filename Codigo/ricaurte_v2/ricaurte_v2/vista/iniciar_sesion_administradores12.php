...
<head>
    ...
    <link rel="stylesheet" href="vista/CSS/iniciar_sesion_administradores12.css">
</head>
<body>
    <div class="container">
    ...
    <div class="form-group text-center">
        <button type="submit" class="btn btn-custom" href="controlador/controlador.php?accion=iniciar_sesion_a">Iniciar Sesión</button>
    </div>
</form>
