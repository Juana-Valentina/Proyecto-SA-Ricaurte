...
<head>
    ...
    <link rel="stylesheet" href="vista/CSS/registro_administrativos14.css">
</head>
<body>
    <div class="container">
        ...
        <form id="registroForm">
            ...
            <div class="text-center">
              <button type="button" class="btn btn-primary" href="controlador/controlador.php?accion=confirmar_correo">Registrar</button>
          </div>
        </form>
