...
<head>
    ...
    <link rel="stylesheet" href="vista/CSS/registro_estudiantes13.css">
</head>
<body>
    <div class="container mt-5">
        ...
        <form id="registration-form">
            ...
            <div class="text-center"> <!-- Centro el botón -->
                <button type="submit" class="btn btn-primary" href="controlador/controlador.php?accion=confirmar_correo">Registrar</button>
            </div>
        </form>
