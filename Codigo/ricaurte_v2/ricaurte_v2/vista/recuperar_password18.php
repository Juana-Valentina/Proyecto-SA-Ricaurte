...
<head>
    ...
    <link rel="stylesheet" href="vista/CSS/recuperar_password18.css">
</head>
<body>
    <div class="container">
        ...
        <div id="verificationCodeDiv">
            ...
            <form id="verificationForm">
                ...
                <button type="button" class="btn btn-primary" href="controlador/controlador.php?accion=crear_contrasena">Verificar Código</button>
            </form>
        </div>
