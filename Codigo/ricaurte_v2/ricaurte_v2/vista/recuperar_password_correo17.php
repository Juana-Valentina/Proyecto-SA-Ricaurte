...
<head>
    ...
    <link rel="stylesheet" href="vista/CSS/recuperar_password_correo1.7.css">
...
<body>
    <div class="container mt-5">
        ...
        <form id="passwordRecoveryForm">
            ...
            <a href="controlador/controlador.php?accion=recuperar_contrasena" class="btn btn-custom btn-block">Continuar</a>
        </form>
