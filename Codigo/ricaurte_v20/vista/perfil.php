  ...
  <body>
    ...
    <div class="profile-header text-center">
      <img id="profileImage" src="Logo.png" alt="Foto de perfil" style="margin-top:90px" class="img-fluid">
    </div>
  </div>
    <div class="col-md-8">
    <div class="profile-details">
            <h2 style="margin-right:229px">Perfil <?php  echo  $rol->nombre_rol;?></h2>
    ...
    <?php if ($rol->nombre_rol == "Profesor") {
        ?><a href="gestionar_asistencia_profesor22.php?Identificacion=<?php echo $Documento ?>" class="btn btn-custom" id="cancelarBtn">Regresar</a><?php
          }elseif ($rol->nombre_rol == "Coordinacion"){
            ?><a href="gestionar_reportes.php?Identificacion=<?php echo $Documento ?>" class="btn btn-custom" id="cancelarBtn">Regresar</a><?php
          }elseif ($rol->nombre_rol == "Secretaria") {
            ?><a href="elegir_subir_archivos.php?Identificacion=<?php echo $Documento ?>" class="btn btn-custom" id="cancelarBtn">Regresar</a><?php
          }else {
            ?><a href="gestionar_asistencia_estudiante21.php?Documento=<?php echo $Documento ?>" class="btn btn-custom" id="cancelarBtn">Regresar</a><?php
          }
    ?>
    <button type="submit" class="btn btn-custom" id="saveButton" name="saveButton">Guardar Cambios</button>
        </div>
  </form>
  </div>
  </div>
