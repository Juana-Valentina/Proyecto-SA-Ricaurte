...
<?php
    ...
    if (isset($_POST['Registrarse'])){
        ...
        if (strlen($_POST['Documento']) >= 1 &&
        strlen($_POST['Correo_institucional']) >= 1 &&
        ...
        strlen($_POST['Contraseña']) >= 1) {
            ...
            $Consulta = "INSERT INTO `persona/registro`(Documento, Correo_institucional, Nombre, Telefono, Contraseña) VALUES ('$Documento','$Correo_institucional','$Nombre','$Telefono','$Contraseña')";
