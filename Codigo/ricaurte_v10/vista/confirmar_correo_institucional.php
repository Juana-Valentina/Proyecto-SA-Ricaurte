...
<body>
    <div class="container" style="width: 700px;">
        ...
        <form id="passwordRecoveryForm">
            ...
            <a href="../controlador/controlador.php?accion=confirmar_codigohtml" class="btn btn-custom btn-block" style="background-color: #FF007A; color:aliceblue">Continuar</a>
        </form>
