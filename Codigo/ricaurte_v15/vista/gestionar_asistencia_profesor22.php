...
<header class="menu">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
            <a class="nav-link" href="../controlador/controlador.php?accion=perfil">Perfil</a>
             </li>
            <li class="nav-item active">
    ...
    <h2>Gestionar Asistencia</h2>
        ...
        while ($cursos = $resultado->fetch_object()) {
            ...
            <tr bgcolor="#f4f4f4 ">
                ...
                <td align="center"><a href="asistencia23.php?Materias=<?php echo $cursos->id_materia?>&Cursos=<?php echo $cursos->nombre_curso ?>&Documentos=<?php echo $documento ?>"><img src="../Imagenes/editar.jpg"  width="29" height="24" /></a></td>
            </tr>
        <?php
        }
