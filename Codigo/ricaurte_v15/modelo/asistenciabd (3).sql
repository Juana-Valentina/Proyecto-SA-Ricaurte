...
-- Tiempo de generación: 20-11-2023 a las 12:39:54
...
(168744875, 'Estudiante', '1103'),
(168797984, 'Estudiante', '1103'),
(185656858, 'Estudiante', '1103'),
(1567654686, 'Estudiante', '1103'),
(1586465485, 'Estudiante', '1103'),
(1684648564, 'Estudiante', '902');
...
(1034657954, 11, '902', 'Profesor'),
(1034657954, 12, '902', 'Profesor'),
(1034657954, 4, '902', 'Profesor'),
(168744875, 4, '1103', 'Estudiante'),
(168797984, 4, '1103', 'Estudiante'),
(185656858, 4, '1103', 'Estudiante'),
(1567654686, 4, '1103', 'Estudiante'),
(1568789458, 4, '1103', 'Estudiante'),
(1586465485, 4, '1103', 'Estudiante'),
(1684648564, 12, '902', 'Estudiante'),
(1034657954, 4, '1103', 'Profesor');
...
(1013577073, 'Secretaria', '3059288474'),
...
ALTER TABLE `asignacion_materia_curso`
  ...
  ADD CONSTRAINT `asignacion_materia_curso_ibfk_4` FOREIGN KEY (`nombre_rol`) REFERENCES `rol` (`nombre_rol`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `asistencia`
  ...
  ADD CONSTRAINT `asistencia_ibfk_3` FOREIGN KEY (`nombre_curso`) REFERENCES `curso` (`nombre_curso`) ON DELETE CASCADE ON UPDATE CASCADE;
