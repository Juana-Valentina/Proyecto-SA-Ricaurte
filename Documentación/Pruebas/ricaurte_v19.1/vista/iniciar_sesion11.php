...
<body>
    ...
    <a href="../index.php" class="btn btn-danger" id="cancelarBtn">Regresar</a>
                <input type="submit" name="Loguearse" class="btn btn-custom" id="Loguearse" name="Enviar">
            </div>

</form>
<p></p>
    <div class="text-center">
    <a href="../controlador/controlador.php?accion=registro_estudiante" class="black-link">Registrarse</a>
    </div>
</div>
</div>
</div>
